...
/// Deze exception handler bevat alle exceptions die door de API kunnen gegenereerd worden.
        ...
        public ResponseEntity<ExceptionResponse> handleException(LockedException e) {
                return ResponseEntity.status(HttpStatus.UNAUTHORIZED)
                                .body(ExceptionResponse
                                                ...
                                                .errorDescription(
                                                                ExceptionStatusCodes.ACCOUNT_DISABLED.getDescription())
                                                .error(e.getMessage())
                                                .build());
        }
        ...
        public ResponseEntity<ExceptionResponse> handleException(BadCredentialsException e) {
                return ResponseEntity.status(HttpStatus.UNAUTHORIZED)
                                .body(ExceptionResponse
                                                ...
                                                .errorDescription(ExceptionStatusCodes.INCORRECT_CREDENTIALS
                                                                .getDescription())
                                                .error(e.getMessage())
                                                .build());
        }
